        ...
        <section class="signup">
            <div class="container">
                <div class="signup-content">
                    <form method="POST" action="{{ route('post.login.admin') }}" id="signup-form" class="signup-form">
                        @csrf
                        <h2 class="form-title">Login Admin</h2>
                        <div class="form-group">
                            <input type="text" class="form-input{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" id="username" placeholder="Username"/>
